...
public enum ExceptionCodes {
    ...
    NOT_ENOUGH_MONEY(3002, HttpStatus.UNPROCESSABLE_ENTITY),
    ...
    //admin actions(6xxx)
    NEW_ROLE_CANNOT_BE_EMPTY(6001, HttpStatus.UNPROCESSABLE_ENTITY),
    ROLE_DOES_NOT_EXIST(6002, HttpStatus.UNPROCESSABLE_ENTITY);
